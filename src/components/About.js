...
function About() {
  return (
    <div className="flex flex-col mx-3 bg-white rounded-md mt-4 lg:flex-row lg:items-center lg:justify-between flex-grow">
        ...
        <div className="m-2 border-b-2 border-gray-200 lg:w-1/4">
            <h1 className="text-sm font-bold text-blue-900 p-1">Quick Links</h1>
        ...
        <h1 className="text-sm font-bold text-blue-900 p-1">Business Hours</h1>
                    ...
                    <div className="flex flex-row items-center justify-between p-1 lg:flex-col lg:items-start">
