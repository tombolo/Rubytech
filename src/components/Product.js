...
function Product({ id, title, price, description, category, image }) {
  ...
  return (
    <div className="relative flex flex-col m-3 bg-white z-30 p-6 rounded-lg shadow-lg hover:shadow-xl transition duration-300 hover:bg-gray-300 transform hover:scale-95">
