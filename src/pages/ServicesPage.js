  ...
  return (
    <div>
        ...
        <div className="md:mt-36 mt-32 lg:flex lg:flex-row lg:items-center lg:justify-evenly">
            ...
            data-aos-easing="ease-in-out" className="px-6  bg-gray-200 shadow-md m-4 rounded-md lg:w-1/2">
                ...
                <p className="list-item text-xs">CIP is particularly important for RO (Reverse Osmosis) membrane systems. RO membranes are susceptible to fouling, scaling, and biological growth, which can negatively impact their performance and lifespan.</p>
            </div>
            ...
            data-aos-easing="ease-in-out" className="px-6  bg-gray-200 shadow-md m-4 rounded-md lg:w-1/2">
                ...
                <p className="list-item text-xs">Cartridge Replacement: Our services include cartridge replacement for various systems and equipment. Whether it's for water filters, air purifiers, or other devices utilizing cartridges, we provide seamless replacement solutions to ensure continued efficiency and effectiveness.</p>
            </div>
...
data-aos-easing="ease-in-out" className="px-6  bg-gray-200 shadow-md m-4 rounded-md lg:w-1/2">
    ...
    <p className="list-item text-xs">Peace of Mind: By opting for an AMC, you gain peace of mind knowing that your equipment or systems are in the hands of professionals. Our team of experts will handle all maintenance tasks, including inspections, repairs, and replacements.</p>
